...
\neutrAuthorListTex{Christoph P.\ Neumann\,\orcidlink{0000-0002-5936-631X}}
% Team example:
...
\neutrAuthorListBib{Christoph P. Neumann}
% Team example:
...
\neutrTitleTex{The \textsmaller{NEUTR} \LaTeX{} Class Technical Report Example}
...
The \textsmaller{NEUTR} formatting is adopted both from \textsmaller{IEEE} \cite{ieee2018formattingrules} and \textsmaller{IARIA} \cite{iaria2014formattingrules} styles.
The \textsmaller{NEUTR} \LaTeX\ class is based on \textsmaller{IEEE}tran class \cite{ieee2015howto}.
